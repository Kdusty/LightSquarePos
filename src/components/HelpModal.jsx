...
const TOPICS = [
  ...
  },
  {
    ...
    icon: "⚙️",
    label: "Settings",
    intro: "Configure your store details, payments, tax rate, BIR info, staff, printer, and subscription.",
    steps: [
      "Store Info: update your store name, owner name, address, and contact number — these appear on every receipt.",
      "Payments (GCash QR): upload your GCash QR code so customers can scan and pay instantly. Tap the upload area to replace it anytime.",
      "Tax & Fees: set your VAT percentage. The default is 12% (Philippine BIR standard). Change only if your store is VAT-exempt.",
      "Receipt & BIR: enter your TIN, VAT accreditation number, and the custom footer message printed on official receipts.",
      "Hardware: connect a USB thermal receipt printer using the 'Connect Printer' button — the browser will prompt you to select your device via Web Serial.",
      "Subscription: view your current plan, days remaining, and upgrade by submitting a GCash reference number.",
      "Staff & Roles: add new staff members with a name, role (Owner / Manager / Cashier), and 4-digit PIN. Edit or deactivate them anytime.",
    ],
  },
];
